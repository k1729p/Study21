...
class ApplicationTests {
	...
	void initialize() throws Exception {
		...
		final PulsarAdmin pulsarAdmin = PulsarAdmin.builder().serviceHttpUrl(pulsarContainer.getHttpServiceUrl())
				.build();
	...
	private void checkDepartment(Department department) {
		...
		department.getCreatedAt().isAfter(OffsetDateTime.parse("2023-01-01T00:00:00+00:00"));
